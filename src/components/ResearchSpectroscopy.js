...
export default class ResearchSpectroscopy extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            slider: require("../data/researchSlider.json").researchSpectroscopy
        };
    }
    render() {
        var settings = {
